...
def predict_model(model_name:str ,features_array):
    ...
    return PredictionOutput(model_name=model_used,
...
async def predict(
    ...
    predictions_output["predictions"].append(predict_model("random_forest", features_array))
    predictions_output["predictions"].append(predict_model("linear_regression", features_array))
